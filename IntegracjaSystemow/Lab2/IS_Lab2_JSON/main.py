...
if confdata['serialization']['source'] == "file":
    ...
    newDeserializator = DeserializeJson(confdata['paths']['json_source_file'])


available_operations = confdata['serialization']['available_operations']
operation_order = confdata['serialization']['order']

# Wykonanie operacji zgodnie z kolejnością
for operation in operation_order:
    if available_operations.get(operation, False):
