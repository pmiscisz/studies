...
//            User u1 = new User(loginToCheck,"asdas", "Andrzej", "Kowalski", Sex.MALE);
//            em.persist(u1);
      ...
      //   Zad 4.3
        ...
        try {
            ...
            List<User> users = Arrays.asList(
                    new User("user6", "pass1", "Jan", "Kowalski", Sex.MALE, new HashSet<>(Arrays.asList(roles.get(0), roles.get(1)))),
                    new User("user7", "pass2", "Anna", "Nowak", Sex.FEMALE, new HashSet<>(Arrays.asList(roles.get(1)))),
                    new User("user8", "pass3", "Tomasz", "Lis", Sex.MALE, new HashSet<>(Arrays.asList(roles.get(2), roles.get(1)))),
                    new User("user9", "pass4", "Ewa", "Dąbrowska", Sex.FEMALE, new HashSet<>(Arrays.asList(roles.get(3)))),
                    new User("user10", "pass5", "Robert", "Wójcik", Sex.MALE, new HashSet<>(Arrays.asList(roles.get(4))))
            );
            ...
            em.getTransaction().begin();
            User user = em.find(User.class, 11L); // Pobranie użytkownika o ID = 1
            if (user != null) {
            ...
            em.getTransaction().begin();
            Role roleToDelete = em.find(Role.class, 15L); // Pobranie roli o ID = 5
...
//            Role adminRole = em.find(Role.class, 11L); // Zakładamy, że ADMIN ma ID = 1
//            Role userRole = em.find(Role.class, 12L);  // Zakładamy, że USER ma ID = 2
//
