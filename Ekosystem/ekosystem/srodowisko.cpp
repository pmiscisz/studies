...
Srodowisko::Srodowisko(unsigned int wiersze, unsigned int kolumny)
    :wiersze(wiersze), kolumny(kolumny), liczbaNisz(wiersze * kolumny)
{
...
void Srodowisko::wykonajKrokSymulacji() {
    ...
    for(Indeksy2D indeks : indeksyLosowe){
